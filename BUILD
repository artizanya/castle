...
nodejs_binary(
  ...
  # entry_point = "@build_bazel_rules_nodejs//:release/npm_bazel_typescript/internal/tsc_wrapped/tsc_wrapped.js",
  data = [
    "@npm//protobufjs",
    ...
    # ".meta/bazel-rules-nodejs/release/npm_bazel_typescript/internal/tsc_wrapped",
